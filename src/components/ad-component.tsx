      ...
      case "banner":
        return (
          <motion.div
            ...
            className="relative overflow-hidden rounded-lg bg-gradient-to-r from-brand-50 to-neutral-50 p-4 dark:from-brand-950/40 dark:to-neutral-900"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <div className="hidden rounded-lg bg-white p-2 shadow-sm dark:bg-neutral-800 sm:block">
                  <span className="text-xs font-semibold text-brand-500">AD</span>
                </div>
                <div>
